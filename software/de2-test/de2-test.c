...
//        print_int(odo->c_qei_value[1],1);
        ...
        if (qei0_last != odo->c_qei_value[0] || qei1_last != odo->c_qei_value[1])
        {
            ...
            qei0_diff = odo->c_qei_value[0]-qei0_last;
            qei1_diff = -(odo->c_qei_value[1]-qei1_last);

            qei0_last = odo->c_qei_value[0];
            qei1_last = odo->c_qei_value[1];
